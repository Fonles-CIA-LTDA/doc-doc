...
class EscalasMenu extends StatefulWidget {
  const EscalasMenu({super.key});

  @override
  State<EscalasMenu> createState() => _EscalasMenuState();
}

class _EscalasMenuState extends State<EscalasMenu> {
  ...
  loadData(pageKey) async {
    var response = await EscalasConnections().getEscalasMenu(pageKey);
  ...
  _model(item) {
    return Container(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed("/escalas?search=false&query="
          ...
          child: Theme(
            ...
            child: Center(
              child: TextField(
                ...
                onSubmitted: (value) {
                  Get.toNamed("/escalas?search=true&query=${value}&id=''");
                },
